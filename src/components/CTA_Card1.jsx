...
const CTA_Card1 = () => {
  return (
    <div className='flex flex-col items-center bg-gradient-to-br from-green-400 to-blue-500 border rounded-lg shadow md:flex-row md:max-w-xl'>
      <div className='max-w-[120px] max-h-[120px] m-2 p-2'>
        <img className='object-cover rounded-lg ' src='/CTA1_Img.png' alt='' />
      </div>
